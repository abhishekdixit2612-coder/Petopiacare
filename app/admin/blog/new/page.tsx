...
import { serializeBlocks, countWordsInBlocks } from '@/types/blog-blocks';
...
export default function WriteBlogPost() {
  ...
  const handleTitleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setFormData(prev => ({ ...prev, title, slug: generateSlug(title), seo_title: title.substring(0, 60) }));
  };
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-10">
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-6 pt-6 border-t border-gray-100">
              <h3 className="text-xs font-bold text-gray-400 uppercase tracking-widest">Metadata & SEO Options</h3>
