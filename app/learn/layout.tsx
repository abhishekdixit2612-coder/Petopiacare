...
const NAV_ITEMS = [
  { label: 'Learn Hub Home', href: '/learn', icon: <Home size={15} /> },
  {
    ...
    icon: <Dog size={15} />,
    children: [
      { label: 'All Breeds',        href: '/learn/breed-guide' },
      { label: 'Indian Pariah Dog', href: '/learn/breed-guide/indian-pariah-dog' },
      { label: 'Labrador Retriever',href: '/learn/breed-guide/labrador-retriever' },
      { label: 'German Shepherd',   href: '/learn/breed-guide/german-shepherd' },
    ],
  },
  {
    label: 'Life Stages',
  ...
  },
  {
    ...
    icon: <Heart size={15} />,
    children: [
      { label: 'All Conditions',    href: '/learn/health-wellness' },
      ...
      { label: 'Vaccination Guide', href: '/learn/health/vaccination' },
    ],
  },
  {
    label: 'Nutrition',
  ...
  },
  {
    ...
    icon: <Brain size={15} />,
    children: [
      { label: 'All Topics',         href: '/learn/behavior-training' },
